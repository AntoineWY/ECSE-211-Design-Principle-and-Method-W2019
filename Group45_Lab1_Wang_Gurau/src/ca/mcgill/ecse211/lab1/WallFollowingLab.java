...
/**
 * main class that runs the entirety of the robot
 * @author Yinuo A Wang
 * @author Tudor Gurau
 */
...
/**
 * entry point for the main class to execute the code
...
//initialize the controllers after the poller starts in order to avoid starting the wheels without the sensor being active
