...
//import ca.mcgill.ecse211.project.Search_LAB5;
 ...
 * 
 * <p>
 * Not necessarily to be used during the demo but helpful during testing and debugging phase.
 * Usually used to print constant change of odometer or color RGB value.
 * @deprecated
 */
public class Display implements Runnable {
  ...
  // If there is color value showing on the display
  private boolean isColorDetection = true;
